        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr.S.S chauhan</h3>
                    <hr/>
                    <h4 align="center">Director<br/>F/o BBDITM</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF.Sandeep kumar Mishra</h3>

                    <h4 align="center">Assistant Professor <br/> BBDITM,lucknow          </h4>
                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/anurag-tiwari.jpg" class="img-rounded"/>
                    <h3 align="center">Dr.Anurag tiwari
                    <hr/>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>BBDEG</h4>
                <h4><strong>Call:</strong> 9837773389 </h4>
                <h4><strong>Email: </strong>time@time.com</h4>
            </div>
